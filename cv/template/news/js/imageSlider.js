...
var bgTitle=["امروز هوا چطوره؟",
"آیا برنامه نویسی درآمد داره؟",
"وبسایت خبری وردپرسی",
"طراحی سایت خبری؟",
"اخبار جدید از سراسر کشور"];
    var change;
    var stage = document.getElementById("stage");
    var btns = document.getElementsByName('radio');
    var i = 1;
    var titlePlace=document.getElementById('bgTitle');
    titlePlace.innerText=bgTitle[i];
